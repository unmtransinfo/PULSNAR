...
# update pulscar_occupancy_alpha.yaml if you want to override the default parameters
if len(sys.argv) < 2:
    user_param_file = 'testparams/pulscar_occupancy_alpha.yaml'
else:
...
# fetch occupancy data and run PU
for pf in pfracs:
    for itr in range(n_iterations):
        ...
        pls = PULSNAR.PULSNARClassifier(scar=True, csrdata=False, classifier='xgboost',
                                        bin_method='fd', bw_method='hist', lowerbw=0.1, upperbw=0.5, optim='local',
