...
# update pulsnar_synthetic_classification.yaml if you want to override the default parameters
if len(sys.argv) < 2:
    user_param_file = 'testparams/pulsnar_synthetic_classification.yaml'
else:
...
rfile = open("results/snar_syn_classification_metrics.tsv", 'w')
...
for pf in pfracs[::-1]:
    ...
    for itr in range(iterations):
        ...
        pls = PULSNAR.PULSNARClassifier(scar=False, csrdata=False, classifier='xgboost',
                                        ...
                                        classification_metrics=True, n_iterations=1, kfold=5, kflips=100,
