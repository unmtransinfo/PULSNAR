...
# update pulscar_dry_beans_alpha.yaml if you want to override the default parameters
if len(sys.argv) < 2:
    user_param_file = 'testparams/pulscar_dry_beans_alpha.yaml'
else:
...
# fetch dry beans data and run PU
for pf in pfracs:
